...
class Exam extends Component {
    ...
    render(){
            var QT2_1 = this.state.buttonPressed2[0][1]? "pressed":"QT6",
          ...
          <div className = "Impression">
            <div className = "impressionHeader"> DD + Confidence </div>
              <div className="buttonGroup1">
                   <ul>
                       <li>
                           <button className="QT1_1">Pneumonia</button>
                           <div class="divider"/>
                       </li>
                       <li>
                           <button className="QT1_2">Acute Pancreatitis</button>
                           <div class="divider"/>
                       </li>
                       <li>
                           <button className="QT_3">Pulmonary infarction</button>
                           <div class="divider"/>
                       </li>
                       <li>
                           <button className="QT1_4">TB</button>
                           <div class="divider"/>
                       </li>
                       <li>
                           <button className="QT1_5">Meigs Syndrome</button>
                       </li>
                   </ul>
            </div>
          </div>
            ...
            <div className = "observationHeader"> Observations </div>
              <div className= "buttonGroup2">
                   <div>
                       <ul>
                           <li>
                               <button className={QT2_1} onClick = {() => this.handleClick2(QT6)}>Large right sided pleural effusion  &lt;90%&gt;</button>
                               <div class="divider"/>
                           </li>
                           <li>
                               <button className={QT2_2} onClick = {() => this.handleClick2(QT7)}>Small left sided pleural effusion  &lt;80%&gt;</button>
                           </li>
                       </ul>
                   </div>
              </div>
        ...
        return(
            <div className="Columns">
              {Impression}
              {Observation}
              {(this.state.showExam = "Examination") ? Examination: null}
            </div>
        );
    }
}
