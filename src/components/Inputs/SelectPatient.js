...
const imageurls = ["https://firebasestorage.googleapis.com/v0/b/chexinterface.appspot.com/o/images%2FMainImages%2Fp11_view1_frontal.jpg?alt=media&token=fe4a268d-8e4d-4c84-8392-78e54631c646",  //11
...
class SelectPatient extends Component {
  ...
  async handleClick(imageName, index){
    ...
    this.props.callbackFromParent(imageurls[index]);
  }
    ...
    return (
      <div className="ImageSelect">
        <div className="PatientImages">
          <ul>
            <li><div className="imageCaption"><img className={imageClass1} src={imageurls[0]} id="0" onClick={() => this.handleClick("00011", 0)}/>Patient 00011</div></li>
            <li><div className="imageCaption"><img className={imageClass2} src={imageurls[1]} id="1" onClick={() => this.handleClick("00012", 1)}/>Patient 00012</div></li>
            <li><div className="imageCaption"><img className={imageClass3} src={imageurls[2]} id="2" onClick={() => this.handleClick("00019", 2)}/>Patient 00019</div></li>
            <li><div className="imageCaption"><img className={imageClass4} src={imageurls[3]} id="3" onClick={() => this.handleClick("00063", 3)}/>Patient 00063</div></li>
            <li><div className="imageCaption"><img className={imageClass5} src={imageurls[4]} id="4" onClick={() => this.handleClick("00067", 4)}/>Patient 00067</div></li>
            <li><div className="imageCaption"><img className={imageClass6} src={imageurls[5]} id="5" onClick={() => this.handleClick("00069", 5)}/>Patient 00069</div></li>
            <li><div className="imageCaption"><img className={imageClass7} src={imageurls[6]} id="6" onClick={() => this.handleClick("00085", 6)}/>Patient 00085</div></li>
            <li><div className="imageCaption"><img className={imageClass8} src={imageurls[7]} id="7" onClick={() => this.handleClick("21622", 7)}/>Patient 21622</div></li>
            <li><div className="imageCaption"><img className={imageClass9} src={imageurls[8]} id="8" onClick={() => this.handleClick("21653", 8)}/>Patient 21653</div></li>
            <li><div className="imageCaption"><img className={imageClass10} src={imageurls[9]} id="9" onClick={() => this.handleClick("21675", 9)}/>Patient 21675</div></li>
            <li><div className="imageCaption"><img className={imageClass11} src={imageurls[9]} id="10" onClick={() => this.handleClick("21677", 10)}/>Patient 21675</div></li>
          </ul>
        </div>
      </div>
    );
